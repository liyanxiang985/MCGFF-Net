...
def get_args():
    ...
    parser.add_argument(
        "--train-dataset", type=str, required=True, choices=["Kvasir", "CVC", "ISIC2018", "ColonDB", "ETIS","PH2", "ISIC2017"]
    )
    parser.add_argument(
        "--test-dataset", type=str, required=True, choices=["Kvasir", "CVC", "ISIC2018", "ColonDB", "ETIS","PH2", "ISIC2017"]
    )
