...
from Data.dataset1 import SegDataset
...
def split_ids(len_ids):
    ...
    # valid_size = ((10 / float(100)) * len_ids)
    # test_size = ((10 / float(100)) * len_ids)
    # print(valid_size)
    # print(test_size)
    # print(len_ids)
...
#     train_size = int(round((80 / 100) * len_ids))
#     valid_size = int(round((10 / 100) * len_ids))
#     test_size = len_ids - train_size - valid_size  # 计算测试集大小
#
...
#         test_val_indices, test_size=(test_size / (valid_size + test_size)), random_state=42
#     )
#
#     return train_indices, test_indices, val_indices
...
def get_dataloaders(input_paths, target_paths, batch_size):
    ...
    transform_target = transforms.Compose(
        [transforms.ToTensor(), transforms.Resize((224, 224)), transforms.Grayscale()]
    )
